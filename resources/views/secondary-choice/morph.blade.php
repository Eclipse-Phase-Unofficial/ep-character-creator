    ...
    function getFormatedMorphList(array $totalMorphList, array $currentList)
    {
	         ...
	         foreach($totalMorphList as $m){
                ...
                if( $m->isInArray($currentList) ){
                    $htmlBlock .= "
                        <li>
                                <a class='morph-BMD' id='".$m->getName()."' href='#'><span class='icone' data-icon='&#x22;'></span>Bonus & Description</a>
                        </li>
                        <li>
                                <a class='morph-settings' id='".$m->getName()."' href='#'><span class='icone' data-icon='&#x27;'></span>settings</a>
                        </li>
                        <li>
                                <a class='morph-positive-traits' id='".$m->getName()."' href='#'>
                        ...
                        <li>
                                <a class='morph-neutral-traits' id='".$m->getName()."' href='#'>
                        ...
                        <li>
                                <a class='morph-negative-traits'  id='".$m->getName()."' href='#'>
                        ...
                        <li>
                                <a class='implants'  id='".$m->getName()."' href='#'>
                        ...
                        <li>
                                <a class='gear'  id='".$m->getName()."' href='#'>
